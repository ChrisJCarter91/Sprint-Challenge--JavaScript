...
const contactInfo = graduates.forEach(function(currentValue) {
  console.log(currentValue.first_name, currentValue.email);
});
...
const animalNames = zooAnimals.forEach(function(currentValue) {
  console.log(`Name: ${currentValue.animal_name} , Scientific Name: ${currentValue.scientific_name}`);
});;
